...
- Restart terminal/RStudio after Quarto installation
...
**Symptom:** RStudio becomes unresponsive
...
- [Bash Learning Playground](../playgrounds/bash-learning-playground.html){target="_blank"} — interactive terminal command simulator
- [Git Learning Playground](../playgrounds/git-learning-playground.html){target="_blank"} — interactive Git and GitHub simulator
