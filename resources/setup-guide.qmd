...
2. **RStudio** (IDE)
   ...
   - Verify: Launch RStudio, create new R file
...
1. Open RStudio
2. Navigate to: `File > Open Project > indicators`
3. In R console, run:
...
1. Open `chapters/01-economy/index.qmd` in RStudio
...
- [ ] Indicators project opens in RStudio
