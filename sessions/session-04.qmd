...
> **Try It (10 min):** Add a label to your figure chunk (e.g. `#| label: fig-my-chart`) and reference it in your text with `@fig-my-chart`. Re-render and check the link works.

### Common Pitfalls

1. **Cross-reference doesn't link** -- Label must start with `fig-` or `tbl-` prefix. Check: `#| label: fig-my-chart` not `#| label: my-chart`.
2. **YAML error on render** -- Indentation matters. Use 2 spaces, never tabs. Check colons have a space after them.
